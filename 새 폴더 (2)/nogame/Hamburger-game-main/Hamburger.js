...
function addMeatFunc() {
    ...
    MeatImg.id="MeatImg" ;
    MeatImg.setAttribute("src", "images/meat.png");
    MeatImg.setAttribute("width", "420");
    MeatImg.setAttribute("height", "30");
    MeatImg.style.display = "block" ;
    MeatImg.style.marginTop ='1%'
    document.getElementById("main").appendChild(MeatImg);
    hamburgerArr.push(2);
  }
function removeMeat() {
var element = document.getElementById("MeatImg");
element.parentNode.removeChild(element);
...
//Lettuce
  function addLettuceFunc() {
    var lettuceImg = document.createElement("IMG");
    lettuceImg.id="lettuceImg" ;
    lettuceImg.setAttribute("src", "images/lettuce.png");
    lettuceImg.setAttribute("width", "420");
    lettuceImg.setAttribute("height", "30");
    lettuceImg.style.display = "block" ;
    lettuceImg.style.marginTop ='1%'
    document.getElementById("main").appendChild(lettuceImg);
    hamburgerArr.push(6);
  }
function removeLettuce() {
var element = document.getElementById("lettuceImg");
element.parentNode.removeChild(element);
