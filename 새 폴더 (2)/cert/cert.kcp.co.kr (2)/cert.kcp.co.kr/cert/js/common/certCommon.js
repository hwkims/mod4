...
try {
    TELCOM_SELECT_URL = TELCOM_SELECT_URL_RW
} catch (e) {
    TELCOM_SELECT_URL = "telcomSelect.jsp"
}


try {
    MO_PUSH_ACTION_URL = MO_PUSH_ACTION_URL_RW
} catch (e) {
    MO_PUSH_ACTION_URL = "pushForm.jsp"
}
try {
    MO_PASS_ACTION_URL = MO_PASS_ACTION_URL_RW
} catch (e) {
    MO_PASS_ACTION_URL = "passConfrim.jsp"
}

try {
    MO_SMS_ACTION_URL = MO_SMS_ACTION_URL_RW
} catch (e) {
    MO_SMS_ACTION_URL = "smsForm.jsp"
}
try {
    MO_OTP_FORM_URL = MO_OTP_FORM_URL_RW
} catch (e) {
    MO_OTP_FORM_URL = "smsOtpForm.jsp"
}
try {
    MO_PUSH_CONFIRM_URL = MO_PUSH_CONFIRM_URL_RW
} catch (e) {
    MO_PUSH_CONFIRM_URL = "pushConfirm.jsp"
}

try {
    MO_SMS_FAIL_URL = MO_SMS_FAIL_URL_RW
} catch (e) {
    MO_SMS_FAIL_URL = "smsFail.jsp"
}
try {
    MO_PASS_FAIL_URL = MO_PASS_FAIL_URL_RW
} catch (e) {
    MO_PASS_FAIL_URL = "passFail.jsp"
}

try {
    MO_PASS_APP_INSTALL = MO_PASS_APP_INSTALL_RW
} catch (e) {
    MO_PASS_APP_INSTALL = "passInstall.jsp"
}

try {
    MO_CERT_TELCOM = MO_CERT_TELCOM_RW
} catch (e) {
    mo_CERT_TELCOM = "../proc/m_cert_telcom.jsp"
}
try {
    MO_CERT_OTP_TX = MO_CERT_OTP_TX_RW
} catch (e) {
    mo_CERT_OTP_TX = "../proc/m_cert_otp_tx.jsp"
}

try {
    MO_MVNO_TELCOM = MO_MVNO_TELCOM_RW
} catch (e) {
    MO_MVNO_TELCOM = "mvnoTelcomConfirm.jsp"
}



try {
    PC_MVNO_TELCOM = PC_MVNO_TELCOM_RW
} catch (e) {
    PC_MVNO_TELCOM = "mvnoTelcomConfirm.jsp"
}

try {
    PC_PUSH_QR_ACTION_URL = PC_PUSH_QR_ACTION_URL_RW
} catch (e) {
    PC_PUSH_QR_ACTION_URL = "pushQRForm.jsp"
}
try {
    PC_PUSH_CONFIRM_URL = PC_PUSH_CONFIRM_URL_RW
} catch (e) {
    PC_PUSH_CONFIRM_URL = "pushConfirm.jsp"
}
try {
    PC_PUSH_QR_FAIL_URL = PC_PUSH_QR_FAIL_URL_RW
} catch (e) {
    PC_PUSH_QR_FAIL_URL = "pushQRFail.jsp"
}

try {
    PC_SMS_ACTION_URL = PC_SMS_ACTION_URL_RW
} catch (e) {
    PC_SMS_ACTION_URL = "smsForm.jsp"
}
try {
    PC_OTP_FORM_URL = PC_OTP_FORM_URL_RW
} catch (e) {
    PC_OTP_FORM_URL = "smsOtpForm.jsp"
}
try {
    PC_SMS_FAIL_URL = PC_SMS_FAIL_URL_RW
} catch (e) {
    PC_SMS_FAIL_URL = "smsFail.jsp"
}

try {
    PC_PASS_APP_INSTALL = PC_PASS_APP_INSTALL_RW
} catch (e) {
    PC_PASS_APP_INSTALL = "passInstall.jsp"
}

try {
    PC_CERT_TELCOM = PC_CERT_TELCOM_RW
} catch (e) {
    PC_CERT_TELCOM = "../proc/cert_telcom.jsp"
}
try {
    PC_CERT_OTP_TX = PC_CERT_OTP_TX_RW
} catch (e) {
    PC_CERT_OTP_TX = "../proc/cert_otp_tx.jsp"
}

try {
    CERT_RESULT_URL = CERT_RESULT_URL_RW
} catch (e) {
    CERT_RESULT_URL = "../common/result.jsp"
}

try {
    IFRAME_TX_APP_PROCESS = IFRAME_TX_APP_PROCESS_RW
} catch (e) {
    IFRAME_TX_APP_PROCESS = "../proc/iframe_tx_app_process.jsp"
}
...
function IframeRequest(url, form, callback, flag) {
    ...
    if (document.getElementById("requestIframe") == undefined) {
        ...
        try {
            window.frames["requestIframe"].name = 'requestIframe';
        } catch (e) {
            void(0);
        }
    }
