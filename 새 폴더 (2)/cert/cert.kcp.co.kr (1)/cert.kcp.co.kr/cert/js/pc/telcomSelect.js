...
function checkAgree() {
    if ($("#agree1").is(":checked") === false) {
        alert('개인정보이용 동의에 동의해 주십시오.', function() {
            $("#agree1").focus();
        });
        return false;
    }
    ...
    if ($("#agree2").is(":checked") === false) {
        alert('고유식별정보 처리 동의에 동의해 주십시오.', function() {
            $("#agree2").focus();
        });
        return false;
    }
    ...
    if ($("#agree3").is(":checked") === false) {
        alert('서비스 이용약관 동의에 동의해 주십시오.', function() {
            $("#agree3").focus();
        });
        return false;
    }
    ...
    if ($("#agree4").is(":checked") === false) {
        alert('통신사 이용약관 동의에 동의해 주십시오.', function() {
            $("#agree4").focus();
        });
        return false;
    }
    ...
    if ($("#agree5").is(":checked") === false && fn_checkedMvnoCommId(fn_getCommId())) {
        alert('제3자 정보제공 동의에 동의해 주십시오.', function() {
            $("#agree5").focus();
        });
        return false;
    }
