window.hjSiteSettings = window.hjSiteSettings || {
    ...
    "features": ["survey.embeddable_widget", "feedback.embeddable_widget", "client_script.compression.pc", "error_reporting", "ask.popover_redesign", "feedback.widget_telemetry", "survey.image_question", "settings.billing_v2", "survey.type_button", "survey.screenshots", "feedback.widgetV2"],
...
! function() {
    ...
    var o, s, c = function() {
        ...
        d = function(t, e, r) {
            var n;
            l.loggedMetrics[t] = a(a({}, l.loggedMetrics[t]), {}, ((n = {})[e] = r || {}, n))
        },
        f = function(t) {
            if (!t) return "value";
        ...
        h = function(t) {
            ...
            return l.isDebugEnabled ? a(a(a({}, r), t.extraTags), l.genericTags) : r
        },
        g = function(t, e) {
            if (!o) return !1;
            ...
            start: function() {
                try {
                    ...
                    return l.genericTags = {
                        site_id: n
                    }, l.isDebugEnabled = Math.random() <= s.universalDebug || a.has("client_script.metrics.debug") && Math.random() <= s.debug, l.isMetricsEnabled = Math.random() <= s.metrics, l.isFieldMetricsEnabled = l.isMetricsEnabled && Math.random() <= s.fieldMetrics, o = new i(b, u.buffer.bufferSize, u.buffer.flushInterval), t
                } catch (t) {
            ...
            count: function(t, e) {
                ...
                try {
                    var c, u = f(n),
                        d = l.loggedMetrics[t],
                        b = 0;
                    if (r ? (b = (d && d[u] || 0) + (r.value || 1), l.loggedMetrics[t] = a(a({}, d), {}, ((c = {})[u] = null != r && r.flush ? 0 : b, c))) : b = 1, g(s, r)) {
                        var v = {
                            name: t,
                            type: "count",
                            value: b,
    ...
    window.hjBootstrap = window.hjBootstrap || function(t, e, r) {
        ...
        d.async = 1, d.src = hj.scriptDomain + e, d.charset = "utf-8", l.appendChild(d), c.revision = "b703042", window.hjBootstrap = c
    }, window.hjLazyModules = window.hjLazyModules || {
        SURVEY_V2: {
            js: "survey-v2.3b5df3e345c901d0b90e.js"
        },
        SURVEY_BOOTSTRAPPER: {
        ...
        USER_TEST: {
            js: "user-test.cd433c2d8cf508e1578f.js"
        }
    }, m ? window._uxa.push(["start:hotjar", window.hjSiteSettings]) : (window.hjBootstrap("https://script.hotjar.com/", "modules.e4b2dc39f985f11fb1e4.js", "1327448"), hj.metrics.timeEnd("resource-blocking-time", {
        tag: {
            resource: "hotjar-js"
        },
        start: w,
