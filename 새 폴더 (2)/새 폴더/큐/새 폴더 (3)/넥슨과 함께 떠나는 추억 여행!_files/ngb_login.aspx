...
var NgbSecurity = new function __NgbSecurity()
{
	...
	var _timeout;
	var _header;
	var _IKELBG73S02SJ4W1 = new Array();
	...
	this.InitData = function()
	{
		...
		_IKELBG73S02SJ4W1.length = 0;
	}
	
	this.AddData = function( _SIUOYVNW2LF9QSGP )
	{
		if ( typeof( _url ) != 'undefined' && typeof( _timer ) != 'undefined' )
			return;
			
		_IKELBG73S02SJ4W1[ _IKELBG73S02SJ4W1.length ] = _SIUOYVNW2LF9QSGP;
	}
	...
	{
		if ( _IKELBG73S02SJ4W1.length == 0 || typeof( handler ) == 'undefined' )
			throw Exception;
	...
	this.HashString = function( _KK9X1D43R6GIPTP2 )
	{
		var hashString = NgbHash.HMAC_SHA256_MAC2( "4E65786F6E55736572", _KK9X1D43R6GIPTP2 );
		return hashString;
	}
	
	this.HashString2 = function( _46S41K0OT8ORPV1K, _KK9X1D43R6GIPTP2, _A8JKH38V66BMRIPK )
	{
		var hashString = _46S41K0OT8ORPV1K + NgbHash.HMAC_SHA256_MAC( _A8JKH38V66BMRIPK, NgbHash.HMAC_SHA256_MAC2( "4E65786F6E55736572", _KK9X1D43R6GIPTP2 ));
		return hashString;
	}
	...
	var ProcessEncrypt = function()
	{
		...
		var _SIUOYVNW2LF9QSGP = '';
		
		if ( typeof( _hash ) != 'undefined' )
			_SIUOYVNW2LF9QSGP = _hash + '\\';
			
		for ( var i = 0; i < _IKELBG73S02SJ4W1.length; i++ )
		{
			_SIUOYVNW2LF9QSGP += NgbRSA.utf8base64encode( _IKELBG73S02SJ4W1[ i ] );
			
			if ( i < _IKELBG73S02SJ4W1.length - 1 )
				_SIUOYVNW2LF9QSGP += '\\';
		}
		
		var val = EncryptString( key, _SIUOYVNW2LF9QSGP );
		_IKELBG73S02SJ4W1.length = 0;
	...
	var EncryptString = function( key, _BEFUOMRRDHQOFSTD )
	{
		...
		var a = new Array();
		var sl = _BEFUOMRRDHQOFSTD.length;
		
		var i = 0;
		while ( i < sl )
		{
			a[ i ] = _BEFUOMRRDHQOFSTD.charCodeAt( i );
			i++;
		}
...
var NgbLogin = new function __NgbLogin()
{
	...
	var _header;
	var _hashKey;
	var __4E70X9ABENBTDNQK;
	var __SNNDGT1PE5SINJCA;
	var _isLogin2;
	var _callBackMethod;
	var _isKeepLogin = '0';
	...
	var _XL8ER4SKMAF8R9WQ;
	
	var _isInvalidPasswordHashKeyString = false;
    var _isFailover = false;
    var _isSLogin = '0';
	
	this.SetData = function( _4E70X9ABENBTDNQK, _SNNDGT1PE5SINJCA, accesscode, strRedirect, isSLogin )
	{
		__4E70X9ABENBTDNQK = _4E70X9ABENBTDNQK;
		__SNNDGT1PE5SINJCA = _SNNDGT1PE5SINJCA;
    ...
    this.SLogin = function (_4E70X9ABENBTDNQK, _SNNDGT1PE5SINJCA, accesscode, strRedirect) {
        NgbLogin.SetData(_4E70X9ABENBTDNQK, _SNNDGT1PE5SINJCA, accesscode, strRedirect, '1');
        _isLogin2 = false;

        if (_4E70X9ABENBTDNQK.indexOf('@') != -1 )
        {
            var arrEmail = _4E70X9ABENBTDNQK.split('@');

            if (arrEmail.length != 2 || arrEmail[0] == '' || arrEmail[1] == '' || _4E70X9ABENBTDNQK.indexOf(' ') != -1 )
            {
                alert('아이디를 확인해 주세요.');
                return;
            }
            ...
            _isFailover = false;
            _XL8ER4SKMAF8R9WQ = _4E70X9ABENBTDNQK;
            AuthSystem.GetPasswordHashKey(_4E70X9ABENBTDNQK, NgbLogin.HashHandler);
    ...
    this.Login = function (_4E70X9ABENBTDNQK, _SNNDGT1PE5SINJCA, accesscode, strRedirect)
	{
		NgbLogin.SetData( _4E70X9ABENBTDNQK, _SNNDGT1PE5SINJCA, accesscode, strRedirect);
		_isLogin2 = false;
	...
	this.Login2 = function( _4E70X9ABENBTDNQK, _SNNDGT1PE5SINJCA, callBackMethod, accesscode )
	{
        ...
        NgbLogin.SetData(_4E70X9ABENBTDNQK, _SNNDGT1PE5SINJCA, accesscode);
		_isLogin2 = true;
	...
	{
		_4E70X9ABENBTDNQK = __4E70X9ABENBTDNQK;
		_SNNDGT1PE5SINJCA = __SNNDGT1PE5SINJCA;
		accesscode = _accesscode;
		strRedirect = _strRedirect;
        isSLogin = _isSLogin;
		
		var strDomain = NgbLogin.GetLoginURL();
		_4E70X9ABENBTDNQK = NgbString.Trim( _4E70X9ABENBTDNQK );
		_SNNDGT1PE5SINJCA = NgbString.Trim( _SNNDGT1PE5SINJCA );
		...
		if ( _4E70X9ABENBTDNQK == '' || _4E70X9ABENBTDNQK.indexOf( ' ' ) != -1 )
		{
			alert( '아이디를 입력해 주세요.' );
			return;
		}
		else if ( _SNNDGT1PE5SINJCA == '' )
		{
			alert( '비밀번호를 입력해 주세요.' );
			return;
		}
		...
		try
		{
			...
			NgbSecurity.AddData( _4E70X9ABENBTDNQK );
			NgbSecurity.AddData( _4E70X9ABENBTDNQK.indexOf( '@' ) != -1 ? NgbSecurity.HashString2( _header, _SNNDGT1PE5SINJCA, _hashKey ) : _SNNDGT1PE5SINJCA );
            NgbSecurity.AddData( NgbHash.SHA256_hash(_SNNDGT1PE5SINJCA));
