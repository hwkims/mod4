...
var NgbSecurity = new function __NgbSecurity()
{
	...
	var _timeout;
	var _header;
	var _6FSJAKNUE1P7KUH1 = new Array();
	...
	this.InitData = function()
	{
		...
		_6FSJAKNUE1P7KUH1.length = 0;
	}
	
	this.AddData = function( _46BSCHTH0B2UTWBF )
	{
		if ( typeof( _url ) != 'undefined' && typeof( _timer ) != 'undefined' )
			return;
			
		_6FSJAKNUE1P7KUH1[ _6FSJAKNUE1P7KUH1.length ] = _46BSCHTH0B2UTWBF;
	}
	...
	{
		if ( _6FSJAKNUE1P7KUH1.length == 0 || typeof( handler ) == 'undefined' )
			throw Exception;
	...
	this.HashString = function( _X17KPA2X4RO18K55 )
	{
		var hashString = NgbHash.HMAC_SHA256_MAC2( "4E65786F6E55736572", _X17KPA2X4RO18K55 );
		return hashString;
	}
	
	this.HashString2 = function( _S4IAS1SN5UPIWI4I, _X17KPA2X4RO18K55, _EM6VP0M7B1PVFMY9 )
	{
		var hashString = _S4IAS1SN5UPIWI4I + NgbHash.HMAC_SHA256_MAC( _EM6VP0M7B1PVFMY9, NgbHash.HMAC_SHA256_MAC2( "4E65786F6E55736572", _X17KPA2X4RO18K55 ));
		return hashString;
	}
	...
	var ProcessEncrypt = function()
	{
		...
		var _46BSCHTH0B2UTWBF = '';
		
		if ( typeof( _hash ) != 'undefined' )
			_46BSCHTH0B2UTWBF = _hash + '\\';
			
		for ( var i = 0; i < _6FSJAKNUE1P7KUH1.length; i++ )
		{
			_46BSCHTH0B2UTWBF += NgbRSA.utf8base64encode( _6FSJAKNUE1P7KUH1[ i ] );
			
			if ( i < _6FSJAKNUE1P7KUH1.length - 1 )
				_46BSCHTH0B2UTWBF += '\\';
		}
		
		var val = EncryptString( key, _46BSCHTH0B2UTWBF );
		_6FSJAKNUE1P7KUH1.length = 0;
	...
	var EncryptString = function( key, _W731MW7UYIYS9C9U )
	{
		...
		var a = new Array();
		var sl = _W731MW7UYIYS9C9U.length;
		
		var i = 0;
		while ( i < sl )
		{
			a[ i ] = _W731MW7UYIYS9C9U.charCodeAt( i );
			i++;
		}
...
var NgbLogin = new function __NgbLogin()
{
	...
	var _header;
	var _hashKey;
	var __9BC7EW8QNTEV8640;
	var __2Y9CTUBHQ9BCQB5C;
	var _isLogin2;
	var _callBackMethod;
	var _isKeepLogin = '0';
	...
	var _QWELMQHC575BA7CR;
	
	var _isInvalidPasswordHashKeyString = false;
    var _isFailover = false;
    var _isSLogin = '0';
	
	this.SetData = function( _9BC7EW8QNTEV8640, _2Y9CTUBHQ9BCQB5C, accesscode, strRedirect, isSLogin )
	{
		__9BC7EW8QNTEV8640 = _9BC7EW8QNTEV8640;
		__2Y9CTUBHQ9BCQB5C = _2Y9CTUBHQ9BCQB5C;
    ...
    this.SLogin = function (_9BC7EW8QNTEV8640, _2Y9CTUBHQ9BCQB5C, accesscode, strRedirect) {
        NgbLogin.SetData(_9BC7EW8QNTEV8640, _2Y9CTUBHQ9BCQB5C, accesscode, strRedirect, '1');
        _isLogin2 = false;

        if (_9BC7EW8QNTEV8640.indexOf('@') != -1 )
        {
            var arrEmail = _9BC7EW8QNTEV8640.split('@');

            if (arrEmail.length != 2 || arrEmail[0] == '' || arrEmail[1] == '' || _9BC7EW8QNTEV8640.indexOf(' ') != -1 )
            {
                alert('아이디를 확인해 주세요.');
                return;
            }
            ...
            _isFailover = false;
            _QWELMQHC575BA7CR = _9BC7EW8QNTEV8640;
            AuthSystem.GetPasswordHashKey(_9BC7EW8QNTEV8640, NgbLogin.HashHandler);
    ...
    this.Login = function (_9BC7EW8QNTEV8640, _2Y9CTUBHQ9BCQB5C, accesscode, strRedirect)
	{
		NgbLogin.SetData( _9BC7EW8QNTEV8640, _2Y9CTUBHQ9BCQB5C, accesscode, strRedirect);
		_isLogin2 = false;
	...
	this.Login2 = function( _9BC7EW8QNTEV8640, _2Y9CTUBHQ9BCQB5C, callBackMethod, accesscode )
	{
        ...
        NgbLogin.SetData(_9BC7EW8QNTEV8640, _2Y9CTUBHQ9BCQB5C, accesscode);
		_isLogin2 = true;
	...
	{
		_9BC7EW8QNTEV8640 = __9BC7EW8QNTEV8640;
		_2Y9CTUBHQ9BCQB5C = __2Y9CTUBHQ9BCQB5C;
		accesscode = _accesscode;
		strRedirect = _strRedirect;
        isSLogin = _isSLogin;
		
		var strDomain = NgbLogin.GetLoginURL();
		_9BC7EW8QNTEV8640 = NgbString.Trim( _9BC7EW8QNTEV8640 );
		_2Y9CTUBHQ9BCQB5C = NgbString.Trim( _2Y9CTUBHQ9BCQB5C );
		...
		if ( _9BC7EW8QNTEV8640 == '' || _9BC7EW8QNTEV8640.indexOf( ' ' ) != -1 )
		{
			alert( '아이디를 입력해 주세요.' );
			return;
		}
		else if ( _2Y9CTUBHQ9BCQB5C == '' )
		{
			alert( '비밀번호를 입력해 주세요.' );
			return;
		}
		...
		try
		{
			...
			NgbSecurity.AddData( _9BC7EW8QNTEV8640 );
			NgbSecurity.AddData( _9BC7EW8QNTEV8640.indexOf( '@' ) != -1 ? NgbSecurity.HashString2( _header, _2Y9CTUBHQ9BCQB5C, _hashKey ) : _2Y9CTUBHQ9BCQB5C );
            NgbSecurity.AddData( NgbHash.SHA256_hash(_2Y9CTUBHQ9BCQB5C));
