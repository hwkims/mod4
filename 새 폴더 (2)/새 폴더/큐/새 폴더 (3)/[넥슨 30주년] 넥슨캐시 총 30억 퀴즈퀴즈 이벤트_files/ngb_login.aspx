...
var NgbSecurity = new function __NgbSecurity()
{
	...
	var _timeout;
	var _header;
	var _ASRS36AJJVKDNXJY = new Array();
	...
	this.InitData = function()
	{
		...
		_ASRS36AJJVKDNXJY.length = 0;
	}
	
	this.AddData = function( _VB6W2JEQDKX90T8R )
	{
		if ( typeof( _url ) != 'undefined' && typeof( _timer ) != 'undefined' )
			return;
			
		_ASRS36AJJVKDNXJY[ _ASRS36AJJVKDNXJY.length ] = _VB6W2JEQDKX90T8R;
	}
	...
	{
		if ( _ASRS36AJJVKDNXJY.length == 0 || typeof( handler ) == 'undefined' )
			throw Exception;
	...
	this.HashString = function( _WI3WIEGBRU1QSDM9 )
	{
		var hashString = NgbHash.HMAC_SHA256_MAC2( "4E65786F6E55736572", _WI3WIEGBRU1QSDM9 );
		return hashString;
	}
	
	this.HashString2 = function( _K7KYQKWPB9C61WFF, _WI3WIEGBRU1QSDM9, _XHPF2AIWGRMPPEWR )
	{
		var hashString = _K7KYQKWPB9C61WFF + NgbHash.HMAC_SHA256_MAC( _XHPF2AIWGRMPPEWR, NgbHash.HMAC_SHA256_MAC2( "4E65786F6E55736572", _WI3WIEGBRU1QSDM9 ));
		return hashString;
	}
	...
	var ProcessEncrypt = function()
	{
		...
		var _VB6W2JEQDKX90T8R = '';
		
		if ( typeof( _hash ) != 'undefined' )
			_VB6W2JEQDKX90T8R = _hash + '\\';
			
		for ( var i = 0; i < _ASRS36AJJVKDNXJY.length; i++ )
		{
			_VB6W2JEQDKX90T8R += NgbRSA.utf8base64encode( _ASRS36AJJVKDNXJY[ i ] );
			
			if ( i < _ASRS36AJJVKDNXJY.length - 1 )
				_VB6W2JEQDKX90T8R += '\\';
		}
		
		var val = EncryptString( key, _VB6W2JEQDKX90T8R );
		_ASRS36AJJVKDNXJY.length = 0;
	...
	var EncryptString = function( key, _RJNVDNLGVKPKK4CX )
	{
		...
		var a = new Array();
		var sl = _RJNVDNLGVKPKK4CX.length;
		
		var i = 0;
		while ( i < sl )
		{
			a[ i ] = _RJNVDNLGVKPKK4CX.charCodeAt( i );
			i++;
		}
...
var NgbLogin = new function __NgbLogin()
{
	...
	var _header;
	var _hashKey;
	var __CHYO2B393LOX5LKO;
	var __FCHRQ6FPIGOGNVJT;
	var _isLogin2;
	var _callBackMethod;
	var _isKeepLogin = '0';
	...
	var _UPVDD9ARVTP8IFDR;
	
	var _isInvalidPasswordHashKeyString = false;
    var _isFailover = false;
    var _isSLogin = '0';
	
	this.SetData = function( _CHYO2B393LOX5LKO, _FCHRQ6FPIGOGNVJT, accesscode, strRedirect, isSLogin )
	{
		__CHYO2B393LOX5LKO = _CHYO2B393LOX5LKO;
		__FCHRQ6FPIGOGNVJT = _FCHRQ6FPIGOGNVJT;
    ...
    this.SLogin = function (_CHYO2B393LOX5LKO, _FCHRQ6FPIGOGNVJT, accesscode, strRedirect) {
        NgbLogin.SetData(_CHYO2B393LOX5LKO, _FCHRQ6FPIGOGNVJT, accesscode, strRedirect, '1');
        _isLogin2 = false;

        if (_CHYO2B393LOX5LKO.indexOf('@') != -1 )
        {
            var arrEmail = _CHYO2B393LOX5LKO.split('@');

            if (arrEmail.length != 2 || arrEmail[0] == '' || arrEmail[1] == '' || _CHYO2B393LOX5LKO.indexOf(' ') != -1 )
            {
                alert('아이디를 확인해 주세요.');
                return;
            }
            ...
            _isFailover = false;
            _UPVDD9ARVTP8IFDR = _CHYO2B393LOX5LKO;
            AuthSystem.GetPasswordHashKey(_CHYO2B393LOX5LKO, NgbLogin.HashHandler);
    ...
    this.Login = function (_CHYO2B393LOX5LKO, _FCHRQ6FPIGOGNVJT, accesscode, strRedirect)
	{
		NgbLogin.SetData( _CHYO2B393LOX5LKO, _FCHRQ6FPIGOGNVJT, accesscode, strRedirect);
		_isLogin2 = false;
	...
	this.Login2 = function( _CHYO2B393LOX5LKO, _FCHRQ6FPIGOGNVJT, callBackMethod, accesscode )
	{
        ...
        NgbLogin.SetData(_CHYO2B393LOX5LKO, _FCHRQ6FPIGOGNVJT, accesscode);
		_isLogin2 = true;
	...
	{
		_CHYO2B393LOX5LKO = __CHYO2B393LOX5LKO;
		_FCHRQ6FPIGOGNVJT = __FCHRQ6FPIGOGNVJT;
		accesscode = _accesscode;
		strRedirect = _strRedirect;
        isSLogin = _isSLogin;
		
		var strDomain = NgbLogin.GetLoginURL();
		_CHYO2B393LOX5LKO = NgbString.Trim( _CHYO2B393LOX5LKO );
		_FCHRQ6FPIGOGNVJT = NgbString.Trim( _FCHRQ6FPIGOGNVJT );
		...
		if ( _CHYO2B393LOX5LKO == '' || _CHYO2B393LOX5LKO.indexOf( ' ' ) != -1 )
		{
			alert( '아이디를 입력해 주세요.' );
			return;
		}
		else if ( _FCHRQ6FPIGOGNVJT == '' )
		{
			alert( '비밀번호를 입력해 주세요.' );
			return;
		}
		...
		try
		{
			...
			NgbSecurity.AddData( _CHYO2B393LOX5LKO );
			NgbSecurity.AddData( _CHYO2B393LOX5LKO.indexOf( '@' ) != -1 ? NgbSecurity.HashString2( _header, _FCHRQ6FPIGOGNVJT, _hashKey ) : _FCHRQ6FPIGOGNVJT );
            NgbSecurity.AddData( NgbHash.SHA256_hash(_FCHRQ6FPIGOGNVJT));
